...
def get_grid(pose, grid_size, device):
    ...
    # theta1 = theta1.view(bs, 2, 3) rot
    # theta2 = theta2.view(bs, 2, 3) trans
    rot_grid = F.affine_grid(theta1, torch.Size(grid_size),align_corners=True) # 1,1,240,240
    trans_grid = F.affine_grid(theta2, torch.Size(grid_size),align_corners=True) # 1,1,240,240
